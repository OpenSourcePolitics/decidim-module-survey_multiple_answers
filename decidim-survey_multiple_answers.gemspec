...
Gem::Specification.new do |s|
  ...
  s.add_dependency "decidim-admin", ">= 0.26.0", "< 0.32.0"
  s.add_dependency "decidim-core", ">= 0.26.0", "< 0.32.0"
  s.add_dependency "decidim-forms", ">= 0.26.0", "< 0.32.0"
  s.add_dependency "decidim-surveys", ">= 0.26.0", "< 0.32.0"
  s.add_development_dependency "decidim-participatory_processes", ">= 0.26.0", "< 0.32.0"
