    ...
    describe Questionnaire do
      ...
      describe "#responded_by?" do
        ...
        it "returns true if the given user has answered the questionnaire" do
          create(:response, questionnaire: questionnaire, question: question, user: user)
          expect(questionnaire).to be_responded_by(user)
        end

        context "when global settings of component allows multiple answers" do
          let!(:response) { create(:response, questionnaire: questionnaire, question: question, user: user) }
